...
class MageAssetCodeAadpter(private val weekForecast: Int, private val itemClick: (Int) -> Unit) : RecyclerView.Adapter<MageAssetCodeAadpter.ViewHolder>() {


    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val view = LayoutInflater.from(parent.context).inflate(R.layout.item_asset_code, parent, false)
